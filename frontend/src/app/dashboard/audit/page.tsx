...
export default function AuditLogPage() {
  ...
  return (
    <div style={{ padding:32 }}>
      <h1 style={{ fontSize:24, fontWeight:700, color:"#111827", marginBottom:8 }}>Audit Log</h1>
      <p style={{ color:"#6b7280", fontSize:14, marginBottom:28 }}>Immutable on-chain record of all claim processing activity</p>
